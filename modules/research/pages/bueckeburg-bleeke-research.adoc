= Kirchenbuch Entries for Bleeke Children
:page-role: doc-width
...
This table summarizes the Lutheran ceremonies that occurred for JHP Bleeke's
children based on his Immanuel Lutheran, Decatur, xref:churches:immanuel/jhp-bleeke.adoc[biography]
