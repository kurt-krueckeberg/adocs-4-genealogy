...
2. Login to to your link:https://www.arcinsys.niedersachsen.de/arcinsys/start.action?oldNodeid=[Arcinsys account]
3. Click on the call number of the volume in the table below.
4. Bookmark it within Arcinsys
5. After you have bookmarked all the volumes you desire, go to
...
6. Add to your *order basket*. This will reserve it for the date you supply.
