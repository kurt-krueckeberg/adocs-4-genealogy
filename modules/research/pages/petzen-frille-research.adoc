...
We also need *citations* for each record. What is the name of the microfiche volume (or roll, etc) and where on
the microfiche is it found, which film number or image number. We need enough information so that someone else can
go to the Bückeburg arhive and find the record easily and verify it.
