...
in the foreword to xref:attachment$Foreword_from_An_Index_to_Naturalzation_Records_in_pre_1907_Order_Books_of_Indiana_County_Courts.pdf[An Index to Naturalization Records In pre-1907 Order Books of
