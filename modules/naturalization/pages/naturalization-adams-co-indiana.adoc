...
those retained by the state of Indiana. The foreward is xref$attachment:An_Index_to_Naturalization_Records_in_pre_1907_Order_Books_of_Indiana_County_Courts.pdf[here].
