...
.Family Search wiki comments on Declaration of Intention
****
...
****
The foreword to  _An Index to Naturalization Record in pre-1907 Order Books of Indiana County Courts_ explains what
exactly is found in Court Order Books versus the naturalization documents:
