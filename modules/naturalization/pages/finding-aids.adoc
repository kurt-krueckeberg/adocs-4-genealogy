...
_An Index to Naturalization Records In pre-1907 Order Books of Indiana County
Courts_, Indiana Historical Society, Indianapolis, 2001, is the 2nd edition of
the early _An index to Indiana naturalization records found in various order
books of the ninety-two local courts prior to 1907_, Indiana Historical Society,
Indianapolis, 1981.
