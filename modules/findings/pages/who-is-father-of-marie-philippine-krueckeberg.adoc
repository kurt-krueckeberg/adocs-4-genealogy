...
in her xref:petzen:petzen-band2-image27-2.adoc[May 12, 1812, marriage record] only her father. In the column for the bride labeled *"Name, Religion, "Geburtsort und Wohnort der Braut"* (*"name, religion,
place of birth and residence of the bride"*), we find this:
...
This Nachtrag (addenda) immediately follows the text above, but is written in a smaller hand:
