...
TODO:
Add these prospective other children in the marriage records below. They should have the bride's
father's name and his address, which is also her address. We can also use the bride's age to
determine the approximate her birth year. Their birth-baptism records will contain both parent's
name and the family's residence.
* xref:petzen:petzen-band2-image27-2.adoc[1812 Marie Philippine Krückeberg Marriage]
* xref:petzen:petzen-band2-image339.adoc[1816 Christine Louise Krückeberg Marriage]
