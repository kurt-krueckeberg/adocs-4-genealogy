...
These marriage records also identifz both parents:
* xref:petzen:petzen-band2-image27-2.adoc[1812 Marie Philippine Krückeberg Marriage]
* xref:petzen:petzen-band2-image339.adoc[1816 Christine Louise Krückeberg Marriage]
...
NOTE: One daughter was born in Steinbergen.

TODO:
To identify the father's, Johann Heinrich's death record, simply state: "I went through all the death records backward from
when he was last mentioned alive (which is likely in one of his children's marriaghe records)...
From thedeath record of Johann Heinrich we learn:
...
We learn:
* his *age* was 38 when he died -> his *approx. birth year* is *1767*
* his *address* -> no. 19 Evesen
