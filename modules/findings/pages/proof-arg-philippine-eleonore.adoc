...
An addendum below this entry states: *“get. 4.5.83”* (baptized 4 May 1783). Thus, while the maiden name is recorded for a 2^nd^ time as
*Blecken*, the mother's
+
** given name,
...
pass:[n.] 11 in Evesen, Luth Conf" translates as: "Philippine Lenore whose maiden name is
