...
1. Rescan the foreward and relevant pages of _An Index to Naturalization Records In pre-1907 Order Books of Indiana County Courts_ 
using OCR, so we can have machine-readable characters.

2. Create a table of individuals

3. Look up the filings, pleadings and final orders for the in
