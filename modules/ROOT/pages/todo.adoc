...
. Check out this record on Ancestry's Library Edition in Genealogy Center:
** https://www.familysearch.org/ark:/61903/1:1:VH7C-TCF?lang=en  It was used to validate the baptism of Anne Marie Philippine Kruckeberg. +
On Archion the link:https://www.archion.de/de/viewer/churchRegister/131705?cHash=5a4efb5d5c47390c81c34fb952a84be4[baptism entries for 1795]
...
. Look up the pages/image number related to the Naturalization of the Adams County Krückebergs.

== Proof Argument

The plan is to use the Imanuel Church book to verify the family certificate.
This would include using the biographies of Johan Heinrich and Carl Wilhelm
Heinrich , along with other Church events and any statistical or other related
information in the church book and the addenda can be used to link records. 

Then to use the addenda to the records from the petzen church along with the
church events that I found for our family to show the accuracy of what we
believe: that there are only two families in Pittston and were one of them

== Note Nachträge and Weiland Relationships

Johann Heinrich Wilhelm Krückeberg, who was baptiyed in 1767, namedßßat least his 2nd and 3rd
