...
1. Look up any of those listed link:https://docs.krueckeberg.org/genealogy/1.0/naturalization/adams-co-wpa-naturaliztion-index.html[here] that I still want to research.
2. Provide citations for those I have looked up, specifically the image number from the unindex collection of Adams Coubnty Court Records.
