...
.Summary of Stand and Einlieger
....
...
[NOTE]
====
Some real insight into the meaning of Einlieger and related words seems to be revealed on images:
* xref:petzen:petzen-band2-image82-2.adoc[Petzen Band2 Image 82-1]
* xref:petzen:petzen-band2-image82-2.adoc[Petzen Band2 Image 82-2]
where the **"Stand"** of the father is given. A small set of around four terms only are used. One of
is **Einlieger**, another is *Anerbe*.
