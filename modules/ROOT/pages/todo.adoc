...
and income down.
== Contact Indiana State Archives for School Enumeration File for Adams County

See xref:research:school-enumerations-indiana.adoc[Krückeberg and Bleekes in 19th Century Indiana School Enumerations].
