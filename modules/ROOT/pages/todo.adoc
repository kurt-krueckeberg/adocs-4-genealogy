...
Look for the early 18th century "Kruckeberg/Kruckeberg" image -- and maybe also .adoc file -- the one that
I am not sure is truly "us" or someone named "Kuckeberg" and whether that person's child is being baptized.

Write up what Anerbenrecht in Schaumburg-Lippe meant See ~/d/genealogy/german_society/Social_Order_17th_18th _Century.odt.

Add history on population explosion: there was a huge increase in population and prices went up
and income down.
