...
|Carl Friedrich Gottlieb|Schneider und Einlieger + (Tailor and landless tennant) |no. 14 Bärenbusch|no. 14 Bärenbusch|Lutheran
|=== 
...
.Child
|===
|Name|Birth Date|Baptism Date|Birth Time|Birth Order|Gender Birth Order
