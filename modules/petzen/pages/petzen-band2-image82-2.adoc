...
The birth month `April` appears near the bottom of page 70 and spans the two columns of `geb[oren]. | get[auft].`,
that is, `born | baptized`. The entries at the top of page 71 continue the births in the month of April, until a
new month is again written in these two colums.
