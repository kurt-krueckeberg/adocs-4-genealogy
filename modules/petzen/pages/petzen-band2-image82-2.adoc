...
The birth month April appears near the bottom of page 70, between entries 18 and 19. It spans the columns for **born** and
**baptized**: **geb[oren]. | get[auft]**. The entries at the top of page 71 continue the births in April
...
`born | baptized`. The entries at the top of page 71 continue the births in April.
