...
[NOTE]
Below Carl Fried. Krückeberg's name, written quite small, appears to be `geb`; however, since many other such
abbreviations on the page are `get`, it must be `get` (getauft [baptized]).
