...
or residence. It is especially helpful in an era when the same limited set of given names appear so frequently and are
used over and over again across generations, and at a time whenn several families may have lived at the same address.
====
****
